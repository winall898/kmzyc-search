...
<script src="/res/js/synonym/synonym.js"></script>
<title>词库管理列表</title>
<style type="text/css">
...
<div width="100%" class="listTitle">
	<span>
		...
		<img src="/etc/images/icon_08.png" />&nbsp;同义词列表&nbsp;
	</span>
</div>
<body>
	<form id="queryForm">
		...
		<table width="98%" class="searcharea"  cellpadding="0" cellspacing="0" align="center">
			<tr height="30px">
				<td align="left">原始词：<input name="keyword" type="text" class="input_style" value=""></td>
				<td align="left">双向同义词：<input name="synonymWord" type="text" class="input_style" value=""></td>
				<td align="left">单向同义词：<input name="unidirWord" type="text" class="input_style" value=""></td>
				<td align="right">
					<input type="button" class="queryBtn" onclick="querySynonymList()">
					<input type="button" class="addBtn" onclick="gotoAddSynonymPage()">
					<input type="button" class="delBtn" onclick="batchDeleteSynonym()">
					<input type="button" class="btn-custom" value="刷新词库" onclick="refreshSynonym()">
					<input type="button" class="btn-custom" value="导入" onclick="gotoImportSynonymPage()">
					<a href="/synonym/downloadSynonymTemp" ><input type="button" class="btn-custom" value="下载导入模板" ></a>
				</td>
			</tr>
		</table>
		<!-- 数据列表区域 -->
