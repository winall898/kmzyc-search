<table width="98%" class="list_table" align="center" cellpadding="3"cellspacing="0" border="1">
	<tr>
		...
		<th align="center" width="10%">原始词</th>
		<th align="center">双向同义词</th>
		<th align="center">单向同义词</th>
		<th align="center">说明</th>
		<th align="center" width="10%">修改日期</th>
		<th align="center" width="10%">修改人</th>
		<th align="center" width="10%">操作</th>
	</tr>
	<#if synonymList?? && synonymList?size gt 0>
		<#list synonymList as item>
			<tr>
				...
				<td align="center">${item.synonymWord}</td>
				<td align="center">${item.unidirWord}</td>
				<td align="center">${item.description}</td>
				<td align="center">${item.updateTime?string("yyyy-MM-dd HH:mm:ss")}</td>
				<td align="center">${item.updater}</td>
				<td align="center">
					<img type="button" style="cursor: pointer;" title="修改" src="/etc/images/button_new/modify.png" onclick="gotoUpateSynonymPage(${item.id})">&nbsp;&nbsp;
					<img type="button" style="cursor: pointer;" title="删除" src="/etc/images/button_new/delete.png" onclick="deleteSynonym(${item.id})">&nbsp;&nbsp;
				</td>
			</tr>
		</#list>
	<#else>
		<tr>
			<td align="center" colspan="9">没有查询到数据</td>
		</tr>
	</#if>
</table>
<!-- 分页数据 -->
