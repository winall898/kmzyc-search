...
<script type="text/javascript" src="/res/js/synonym/synonym.js"></script>
...
<div width="100%" class="listTitle">
	<span>
		...
		<img src="/etc/images/icon_08.png" />&nbsp;同义词管理&nbsp;
		<img src="/etc/images/icon_08.png" />&nbsp;修改同义词&nbsp;
	</span>
</div>
<body>
	<!-- 数据编辑区域 -->
<form id="dataForm">
	<input type="hidden" id="id" name="id" value="${synonymVo.id}">
	<table width="95%" class="edit_table" align="center" cellpadding="3" cellspacing="0" border="1" bordercolor="#C7D3E2" style="border-collapse: collapse; font-size: 12px;">
		<tr>
			<th width="20%" align="right" class="eidt_rowTitle"><font color="red">*</font>原始词：</th>
		  	<td width="80%">
		   		<input type="text" name="keyword" id="keyword" value="${synonymVo.keyword}" size="70" maxlength="70" style="width:400px" onblur=""/>
		  	</td>
		</tr>
		<tr>
			<th align="right" class="eidt_rowTitle">双向同义词：</th>
			<td><label><textarea name="synonymWord" id="synonymWord" rows="8" cols="45" maxlength="1000">${synonymVo.synonymWord}</textarea></label><label style="vertical-align: bottom;">多个同义词请用","分开。</label></td>
		</tr>
		<tr>
			<th align="right" class="eidt_rowTitle">单向同义词：</th>
			<td><label><textarea name="unidirWord" id="unidirWord" rows="8" cols="45" maxlength="1000">${synonymVo.unidirWord}</textarea></label><label style="vertical-align: bottom;">多个同义词请用","分开。</label></td>
		</tr>
		<tr>
			<th align="right" class="eidt_rowTitle">说明：</th>
			<td><label><textarea name="description" id="description" rows="8" cols="45" maxlength="2000">${synonymVo.description}</textarea></label></td>
		</tr>
		<tr>
			<td></td>
			<td align="left">
				<input  class="saveBtn" type="button" onclick="saveSynonym()"/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
