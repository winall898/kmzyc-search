...
<div width="100%" class="listTitle">
	<span>
		...
		<img src="/etc/images/icon_08.png" />&nbsp;添加同义词&nbsp;
	</span>
</div>
<body>
	<!-- 数据编辑区域 -->
<form id="dataForm">
	...
	<table width="95%" class="edit_table" align="center" cellpadding="3" cellspacing="0" border="1" bordercolor="#C7D3E2" style="border-collapse: collapse; font-size: 12px;">
		...
		<tr>
			...
			<td><label><textarea name="synonymWord" id="synonymWord" rows="8" cols="45" maxlength="1000"></textarea></label><label style="vertical-align: bottom;">多个同义词请用","分开。</label></td>
		</tr>
		<tr>
			<th align="right" class="eidt_rowTitle">单向同义词：</th>
			<td><label><textarea name="unidirWord" id="unidirWord" rows="8" cols="45" maxlength="1000"></textarea></label><label style="vertical-align: bottom;">多个同义词请用","分开。</label></td>
		</tr>
		<tr>
			<th align="right" class="eidt_rowTitle">说明：</th>
			<td><label><textarea name="description" id="description" rows="8" cols="45" maxlength="2000"></textarea></label></td>
		</tr>
		<tr>
			<td></td>
			<td align="left">
