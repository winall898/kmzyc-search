	...
	<#if keywordList?? && keywordList?size gt 0>
		<#list keywordList as item>
			<tr>
				...
				<td align="center">
					<img type="button" style="cursor: pointer;" title="修改" src="/etc/images/button_new/modify.png" onclick="gotoUpateKeywordPage(${item.id})">&nbsp;&nbsp;
					<img type="button" style="cursor: pointer;" title="删除" src="/etc/images/button_new/delete.png" onclick="deleteKeyword(${item.id})">&nbsp;&nbsp;
				</td>
			</tr>
		</#list>
	<#else>
