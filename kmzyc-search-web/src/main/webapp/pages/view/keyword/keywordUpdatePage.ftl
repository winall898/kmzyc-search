...
<div width="100%" class="listTitle">
	<span>
		...
		<img src="/etc/images/icon_08.png" />&nbsp;修改分词&nbsp;
	</span>
</div>
<body>
	<!-- 数据编辑区域 -->
<form id="dataForm">
	<input type="hidden" id="id" name="id" value="${keywordVo.id}">
	<table width="95%" class="edit_table" align="center" cellpadding="3" cellspacing="0" border="1" bordercolor="#C7D3E2" style="border-collapse: collapse; font-size: 12px;">
		<tr>
			<th width="20%" align="right" class="eidt_rowTitle"><font color="red">*</font>分词：</th>
		  	<td width="80%">
		   		<input type="text" name="keyword" id="keyword" value="${keywordVo.keyword}" size="70" maxlength="70" style="width:400px" onblur=""/>
		  	</td>
		</tr>
		<tr>
			<th align="right" class="eidt_rowTitle">说明：</th>
			<td><label><textarea name="description" id="description" rows="8" cols="45">${keywordVo.description}</textarea></label></td>
		</tr>
		<tr>
			<td></td>
			<td align="left">
