...
<div width="100%" class="listTitle">
	<span>
		...
		<img src="/etc/images/icon_08.png" />&nbsp;分词列表&nbsp;
	</span>
</div>
<body>
	<form id="queryForm">
		...
		<table width="98%" class="searcharea"  cellpadding="0" cellspacing="0" align="center">
			<tr height="30px">
				<td align="left">分词：<input name="keyword" type="text" class="input_style" value=""></td>
				<td align="right" rowspan="2" >
					<input type="button" class="queryBtn" onclick="queryKeywordList()">
					<input type="button" class="addBtn" onclick="gotoAddKeywordPage()">
					<input type="button" class="delBtn" onclick="batchDeleteKeyword()">
					<input type="button" class="btn-custom" value="刷新词库" onclick="refreshKeyword()">
					<input type="button" class="btn-custom" value="导入" onclick="gotoImportKeywordPage()">
					<a href="/keyword/downloadKeywordTemp" ><input type="button" class="btn-custom" value="下载导入模板" ></a>
				</td>
			</tr>
		</table>
		<!-- 数据列表区域 -->
